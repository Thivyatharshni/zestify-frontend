                ...
                <div className="group relative overflow-hidden bg-white/10 backdrop-blur-lg hover:bg-white/15 p-6 rounded-3xl border border-white/20 transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] cursor-pointer">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="flex items-center gap-1 text-emerald-300 font-black text-xs bg-emerald-500/20 px-2 py-1 rounded-lg backdrop-blur-sm">
                                <TrendingUp size={14} />
                                +18%
                            </div>
                        </div>
                        <h3 className="text-4xl font-black text-white tracking-tighter mb-2 drop-shadow-sm">₹{(stats?.totalRevenue || 0).toLocaleString()}</h3>
                        <p className="text-xs font-black uppercase tracking-widest text-white/60">GMV</p>
                    </div>
                </div>
            </div>
